...
<div class="banner"><a href="#"><img src="img/banner1.jpg"/></a></div>
<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="indexselect">首页</a><span>/</span><a
            href="flowerDer.html">精品书城</a><span>/</span><a href="proList.html" class="on">${title }</a></div>
</div><!-------------------current---------------------->
<div class="current">
        ...
        <div class="fr">
            <div class="proIntro"><p>颜色分类</p>
                ...
                <div class="num clearfix">
                    ...
                    <span class="fl" contentEditable="true">1</span><img
...
<div class="footer">
    ...
    <p class="dibu">vector&copy;2013-2017公司版权所有 京ICP备080100-44备0000111000号<br/>
