...
<div class="head">
    ...
    <div class="wrapper clearfix">
        <div class="clearfix" id="top"><h1 class="fl"><a href="index.jsp"><img src="images/logo.png"/></a></h1>
            <div class="fr clearfix" id="top1"><p class="fl">
                ...
                <c:if test="${isAdminLogin == 1 }">
                    <a href="/booktown/backstage/admin_index.jsp" id="login1"><span>进入后台</span></a>
                </c:if>
            </p>
                <form action="#" method="get" class="fl"><input type="text" placeholder="热门搜索：java web"/><input
                        type="button"/></form>
