...
<header class="lyear-layout-header">
    <iframe  allow="autoplay" hidden frameborder="no" border="0" marginwidth="0"  marginheight="0" width=330 height=86 src="//music.163.com/outchain/player?type=2&id=31654455&auto=1&height=66"></iframe>
    <nav class="navbar navbar-default">
        <div class="topbar">
            ...
            <div class="topbar-left">
                ...
                <span class="navbar-page-title"> <a href="admin_index.jsp">后台首页</a>&ensp;&ensp;&ensp;&ensp;<a href="/booktown/indexselect">网站首页</a> </span>
            </div>
            <ul class="topbar-right">
                <li class="dropdown dropdown-profile">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li class="divider"></li>
                        <li><a href="/booktown/backstage/adminlogoutServlet"><i class="mdi mdi-logout-variant"></i> 退出登录</a></li>
                    </ul>
                </li>
                <!--切换主题配色-->
