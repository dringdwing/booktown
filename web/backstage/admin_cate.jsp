        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                ...
                <span class="navbar-page-title"> <a href="admin_index.jsp">后台首页</a> -> <a
                        href="/booktown/backstage/admin_cateselectServlet">分类管理</a></span>
            </div>
                ...
                <div class="card">
                    ...
                    <form action="/booktown/backstage/admin_delServlet" method="post" id="myform">
                        <div class="card-body">
                            ...
                            <h5><a href="/booktown/backstage/admin_tocateaddServlet">新增分类</a>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                                <a href="">更新排序</a></h5>
                                    ...
                                    <c:forEach var="cate" items="${catelist}">
                                        <c:if test="${ cate.CATE_PARENT_ID == 0}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="link-update" href="admin_tocateupdateServlet?id=${cate.CATE_ID }">修改</a>
                                            ...
                                            <c:forEach var="zcate" items="${catelist}">
                                                <c:if test="${zcate.CATE_PARENT_ID ==cate.CATE_ID }">
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <a class="link-update" href="admin_tocateupdateServlet?id=${zcate.CATE_ID }">修改</a>
                                                        <a class="link-del" href="javascript:catedel(${zcate.CATE_ID });">删除</a>
                                                        </td>
                                                    </tr>
                                                </c:if>
                                            </c:forEach>
                                    ...
                                    <script>
                                        function catedel(id) {
                                            if(confirm("你确认要删除这个分类吗")) {
                                                location.href="admin_docatedelServlet?id="+id;
                                            }
                                        }
                                    </script>
                                </table>
